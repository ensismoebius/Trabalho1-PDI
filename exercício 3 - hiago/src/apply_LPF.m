function x = apply_LPF(input_img_read, n1, n2, n3, n4, t1)

figure(n1); imshow(input_img_read); title(t1)
PQ = paddedsize(size(input_img_read));%Determine good padding for Fourier transform

%Create a Ideal Lowpass filter N% the width of the Fourier transform
D0 = 0.04*PQ(1);H = lpfilter('ideal', PQ(1), PQ(2), D0);
